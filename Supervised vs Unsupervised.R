...
token <- create_token(
  app = "WPUTWEETRESEARCH",
  consumer_key = "OW6BaU9gqk1yUUhwr1GkT6XFs",
  consumer_secret = "tgUrMzZce2gEXraY2MnX1TvEEzUZZ20ltbVhf6yodf2GEfN6nt",
  access_token = "1050761424761495555-VKmdqFnHCHjbiOMcSrXVbg9RMVhxfk",
  access_secret = "KufKW7sMlprcRF7GYPcqOuU9qYRrujYsutXbB417wSq7a")
#-------------------------------------------------------x
#-------------------------------------------------------x
### New
#Create Twitter API Token
token <- create_token(
  app = "AI 11/20/2019",
  consumer_key = "HYEWVCpTuc6t3JqxzJhBeB7v6",
  consumer_secret = "RdwFnXISKT8CXKi84nOvXjlKwp4FO5B7tDu4e6tqYFHVjDzT4r",
  access_token = "2722672516-WTkVni4o0FcerFNK2jqFx8z5Ngn9U9nYfYNaQoa",
  access_secret = "JzjGUG0OLKmSI9RUQKkrdyrr6zZRPRNvOonbmDKv6mepO")
